 ...
 * @param {Function} [callback] results in format {width:,height:}
 ...
 * @param  {String} path
 * @param {Function} [callback] result in format {format:, width:, height:}
 * @return {Promise} - resolved with {format:, width:, height:}
 */
exports.identify = function (path, callback) {
	var defer = Promise.defer(),
